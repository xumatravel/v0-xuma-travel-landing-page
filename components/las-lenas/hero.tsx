      ...
      <div className="relative z-10 container mx-auto px-6 pt-24 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-none mb-6">
            <span className="block">{t("lasLenasPage.hero.title1")}</span>
            <span className="block">{t("lasLenasPage.hero.title2")}</span>
          </h1>

          {/* Subheadline */}
          <p className="text-white/90 text-xl md:text-2xl leading-relaxed mb-6 max-w-2xl mx-auto font-light">
            {t("lasLenasPage.hero.subtitle")}
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-10">
            <div className="flex items-center gap-2 text-white/90 bg-white/10 px-4 py-2 rounded-full">
              ...
              <span className="text-sm">{t("lasLenasPage.hero.trust1")}</span>
            </div>
            <div className="flex items-center gap-2 text-white/90 bg-white/10 px-4 py-2 rounded-full">
              <Clock className="w-5 h-5 text-[#6B7D5C]" />
              <span className="text-sm">{t("lasLenasPage.hero.trust2")}</span>
            </div>
            <div className="flex items-center gap-2 text-white/90 bg-white/10 px-4 py-2 rounded-full">
              <Award className="w-5 h-5 text-[#6B7D5C]" />
              <span className="text-sm">{t("lasLenasPage.hero.trust3")}</span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            ...
            >
              ...
              {t("lasLenasPage.hero.cta2")}
            </Button>
          </div>

          {/* Response time hint */}
          <p className="text-white/60 text-sm">
            {t("lasLenasPage.hero.response")}
          </p>
        </div>
      </div>
