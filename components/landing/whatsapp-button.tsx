...
export function WhatsAppButton() {
  ...
  return (
    <button
      onClick={handleClick}
      className="group fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110"
