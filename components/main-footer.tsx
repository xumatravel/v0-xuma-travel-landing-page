    ...
    <footer className="bg-[#0B0B0B] border-t border-white/10">
      <div className="container mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/60 leading-relaxed max-w-md mb-6">
              Transfers privados y seguros a Las Leñas. Vehículos 4x4 equipados para montaña y conductores expertos. Tu viaje comienza con nosotros.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-serif font-semibold text-white mb-4">Navegación</h3>
          ...
          <div>
            ...
            <h3 className="font-serif font-semibold text-white mt-8 mb-4">Otros Servicios</h3>
            <ul className="space-y-3">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/40 text-sm">
            Transfers seguros a Las Leñas desde Mendoza y San Rafael
          </p>
        </div>
      </div>
    </footer>
