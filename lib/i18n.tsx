...
const translations: Record<Locale, Record<string, TranslationValue>> = {
  es: {
    ...
    "contact.form.departureDate": "Fecha de salida (opcional)",
  ...
  pt: {
    ...
    "contact.form.departureDate": "Data de saída (opcional)",
  ...
  en: {
    ...
    "contact.form.departureDate": "Departure date (optional)",
